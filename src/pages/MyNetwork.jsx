...
export default function MyNetwork() {
  ...
  async function handleMessage(person) {
    ...
    if (person.is_city_active === 0) {
      setMessage(
        person.inactive_message || "Move city to activate this connection."
      );
      return;
    }
  ...
  return (
    <div className="cn-page my-network-v2-page">
      {message && (
      ...
      <div className="network-premium-toolbar">
        <div className="toolbar-city-info">
          <MapPin size={17} />
          Showing people in {user.active_city || user.city || "your active city"}
        </div>
      ...
      {loading ? (
        ...
        <div className="my-posts-empty-premium">
          ...
          <h2>No people found in this city</h2>

          <p>
            ConnectNowww only shows people in your active city. Use Local Radar or
            update your city to discover people elsewhere.
          </p>
        </div>
      ) : (
        <section className="premium-network-grid">
          {visiblePeople.map((person) => (
            <div
              className={
                person.is_city_active === 0
                  ? "premium-person-card inactive-city-card"
                  : "premium-person-card"
              }
            ...
            >
              ...
              {person.is_city_active === 0 && (
                <div className="inactive-city-banner">
                  {person.inactive_message ||
                    "Move city to activate this connection."}
                </div>
              )}
              ...
              <div className="premium-person-top">
                ...
                <div>
                  ...
                  <p>
                    <MapPin size={13} />
                    {person.active_city || person.city || "Location not added"}
                  </p>
                </div>
              </div>
                ...
                {activeTab === "requests" ? (
                  ...
                  <>
                    <button
                      ...
                      disabled={person.is_city_active === 0}
                      className={
                        person.is_city_active === 0 ? "disabled-action-btn" : ""
                      }
                    >
      ...
      <div className="network-premium-footer">
        ...
        <div>
          ...
          <p>
            ConnectNowww will soon recommend people based on your skills,
