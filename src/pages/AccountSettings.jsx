  ...
  return (
    <div className="home-page">
      ...
      <main className="main-content">
        <Topbar
          title="Account Settings"
          subtitle="Manage your identity, security and account access"
        />
        ...
        <div className="settings-premium-layout">
          <div className="settings-profile-card">
            ...
            <h2>{user.name || "ConnectNow User"}</h2>
          ...
          <div className="settings-main-card">
            ...
            <p className="modal-subtitle">
              This information personalizes your local experience and helps
              people identify you across ConnectNow.
            </p>
          ...
          <div className="settings-danger-card">
            ...
            <p>
              Deactivating your account will prevent login from this account.
              Your historical content may remain for audit and product integrity.
            </p>
